...
import usePublicKanban from '../hooks/usePublicKanbanData'
...
const PublicKanban = ({userId}) => {
    ...
    const {initialData, setInitialData, boardName} = usePublicKanban(userId, boardId)
                            ...
                            <header className='bg-white z-10 text-sm sm:text-base py-5 mx-3 md:mx-6'>
                                <div className='flex flex-wrap justify-between items-center'>
                                    <span className='text-xl'>
                                        ...
                                        <span className=''>/</span>
                                        <input type="text" defaultValue={boardName} className='text-gray-800 ml-2 w-1/2 truncate' />
                                    </span> 
