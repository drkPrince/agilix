...
const Column = ({column, tasks, allData, boardId, userId, filterBy}) => {
    ...
    return (
        <div className='mx-2 rounded overflow-hidden bg-gray-300 w-1/4 card' style={{'minHeight': '200px'}}> 
            ...
            <Droppable droppableId={column.id} key={column.id}>
                {(provided, snapshot) => 
                    <div {...provided.droppableProps} ref={provided.innerRef} className={`h-full py-4 px-2 transition-all duration-1000 ${snapshot.isDraggingOver ? 'bg-gradient-to-b from-gray-200 via-gray-400 to-gray-600' : ''}`}>
                        <div>
